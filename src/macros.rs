...
/// Polars v0.52 specific data ingestion macro.
#[macro_export]
macro_rules! load_polars_052 {
    ($df:expr) => {{
        let df = $df;
        let mut dataset: $crate::core::data::Dataset = $crate::core::data::Dataset::new();
...
/// Polars v0.51 specific data ingestion macro.
#[macro_export]
macro_rules! load_polars_051 {
    ($df:expr) => {{
        let df = $df;
        let mut dataset: $crate::core::data::Dataset = $crate::core::data::Dataset::new();
...
/// Polars v0.50 specific data ingestion macro.
#[macro_export]
macro_rules! load_polars_050 {
    ($df:expr) => {{
        let df = $df;
        let mut dataset: $crate::core::data::Dataset = $crate::core::data::Dataset::new();
...
/// Polars v0.49 specific data ingestion macro.
#[macro_export]
macro_rules! load_polars_049 {
    ($df:expr) => {{
        let df = $df;
        let mut dataset: $crate::core::data::Dataset = $crate::core::data::Dataset::new();
