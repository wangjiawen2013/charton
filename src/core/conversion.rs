...
mod tests {
    ...
    #[test]
    fn test_chart_conversion_via_from_trait() -> Result<(), crate::error::ChartonError> {
        let df = df!["x" => [1, 2, 3], "y" => [10, 20, 30]]?;
        ...
        // Test conversion using From trait
        let layered_chart: LayeredChart = chart.into();
        
        // Verify the conversion worked by checking that it produces valid SVG
        // rather than accessing private fields
        let svg_result = layered_chart.to_svg();
    ...
    #[test]
    fn test_chart_conversion_via_into_layered_method() -> Result<(), crate::error::ChartonError> {
        let df = df!["x" => [1, 2, 3], "y" => [10, 20, 30]]?;
        ...
        // Test conversion using into_layered method
        let layered_chart = chart.into_layered();
