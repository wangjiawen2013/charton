...
pub(crate) struct VerticalBarConfig {
    pub x_center: f64,
    pub y_zero: f64,
    pub y_value: f64,
    pub width: f64,
...
pub(crate) struct HorizontalBarConfig {
    pub x_zero: f64,
    pub x_value: f64,
    pub y_center: f64,
    pub height: f64,
...
/// * `config` - Configuration parameters for the vertical bar
///
/// # Returns
/// Result indicating success or failure of the operation
pub(crate) fn render_vertical_bar(svg: &mut String, config: VerticalBarConfig) -> std::fmt::Result {
...
/// # Parameters
/// * `svg` - A mutable reference to the SVG string being built
/// * `config` - Configuration parameters for the horizontal bar
///
/// # Returns
/// Result indicating success or failure of the operation
